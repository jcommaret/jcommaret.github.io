...
function Sidebar() {
  ...
  const contacts: Contact[] = [
    { icon: mailOutline, title: 'Email', link: 'mailto:jcommaret@gmail.com?subject=Contact%20depuis%20jcommaret.github.io&body=Bonjour%20J%C3%A9r%C3%B4me%2C%0A%0AJe%20souhaite%20travailler%20avec%20vous.%0A%0AMes%20coordonn%C3%A9es%20%3A%0A%0ANom%20%3A%20%0APr%C3%A9nom%20%3A%20%0AT%C3%A9l%C3%A9phone%20%3A%20%0AEmail%20%3A%20%0A%0ACordialement' },
        ...
        <button className="info_more-btn" data-sidebar-btn aria-label="Contactez moi">
          <span>
            {contacts
              ...
              .map((contact, index) => (
                <NavLink key={index} to={contact.link} className="contact-link">Contactez-moi</NavLink>
              ))}
          </span>
        </button>
      </div>
