const img = {
    ...
    projectImage4 : new URL('./project-4.png', import.meta.url).href,
    projectImage5 : new URL('./project-5.png', import.meta.url).href,
    projectImage6 : new URL('./project-6.png', import.meta.url).href,
    projectImage7 : new URL('./project-7.png', import.meta.url).href,
    projectImage8 : new URL('./project-8.jpg', import.meta.url).href,
    projectImage9 : new URL('./project-9.png', import.meta.url).href,
