const img = {
    ...
    projectImage1 : new URL('./project-1.png', import.meta.url).href,
    projectImage2 : new URL('./project-1.png', import.meta.url).href,
    projectImage3 : new URL('./project-1.png', import.meta.url).href,
    projectImage4 : new URL('./project-1.png', import.meta.url).href,
    projectImage5 : new URL('./project-1.png', import.meta.url).href,
